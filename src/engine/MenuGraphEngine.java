...
public class MenuGraphEngine
{
    public MenuGraphEngine(){
    ...
    public static void  startMenu() {
        ...
        System.out.println("=== BIENVENIDO A GRAPH ENGINE ===");
        ...
        while (selectingFile) {
            ...
            System.out.println("> Ruta del archivo seleccionada: " + filePath);
            ...
            try {
                ...
                System.out.println("\n> Archivo leído correctamente." + "\n> Aristas encontradas: " + edges.size() );
                ...
                while (running) {
                    ...
                    switch (option) {
                        ...
                        case 11: // Seleccionar otro archivo
                            running = false;
                            System.out.println("> Seleccionando nuevo archivo...");
                            break;
    ...
    public static String selectFileInterface(Scanner scanner) {
        ...
        while (true) {
            ...
            if (answerUser.isEmpty()) {
                System.out.println("> Abriendo ventana de selección de archivo...");
